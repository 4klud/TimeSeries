...
# 1. Determine if it is invertible or stationary/causal.
...
# 2. Generate a sample path using n = 100 observations, and produce the sample ACF and sample PACF
...
# 3. Produce the true ACF and the true PACF and compare with the sample ACF and sample PACF, respectively.
